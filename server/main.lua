...
local RESOURCE_NAME = 'EN-identity'
...
if currentResource ~= RESOURCE_NAME then
    print(('^1[ENZO CODE] ERROR: Resource name changed. Rename "%s" back to "%s".^0'):format(currentResource, RESOURCE_NAME))
    print('^1[ENZO CODE] Resource stopped because the folder/resource name is invalid.^0')
...
print(('^2[ENZO CODE] %s started successfully.^0'):format(RESOURCE_NAME))
...
local function convertTimestampToDate(value)
